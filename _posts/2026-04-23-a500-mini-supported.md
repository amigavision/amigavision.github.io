...
Original announcement of our biggest release ever follows, for those of you that didn't catch it at the time:
...
We were also interviewed on AmigaBill's channel about this release if you want a 2-hour deep-dive talking about the new emulator scaling *&* our focus on low latency and accuracy:

<iframe
  style="aspect-ratio:16/9;width:100%;" 
  src="https://player.twitch.tv/?video=v2746470548&time=26m38s&autoplay=false&parent=amiga.vision"
  title="Twitch Video Player"
  frameborder="0"
  allowfullscreen>
</iframe>

<a href="https://www.twitch.tv/videos/2746470548?t=00h26m38s" target="_blank">Open in new tab</a>

## 🌍 AmigaVision on Every Platform

One of the most significant new additions in this release is adding lots of new supported platforms for AmigaVision.
...
As you can see in this particular example, this results in people's faces looking much shorter/wider than they are intended to be, and mis-represents the original intent of the artist.
...
We will endeavour to work with the remaining dominant Amiga emulators to help out there too, so hopefully this can be fixed everywhere soon! If any emulator authors want to talk scaling, hit us up for the nerdy details. 😄

## 16:9 Widescreen *&* 21:9 Ultrawide Scaling for Emulators

Did you know that many Amiga demos *&* games — despite running on a platform from 1985 — run in 16:9 or 16:10 aspect ratios without any stretching of the original image? Or even 21:9 aspect ratios? Truly a computer ahead of its time.
...
With this release of AmigaVision, we are bringing 16:9, 16:10 — and even 21:9 Ultrawide cinematic aspect ratio scaling — to games and demos that support it, like the intro to Pinball Illusions from 1995:
...
So with today's release, people can experience 16:9, 16:10, and 21:9 Amiga content on emulators too, like this 21:9 Ultrawide demo scene production by Logicoma from 2025, which will display full-width on displays like 1440p and 5K2K 21:9 Ultrawide displays:
...
See below for some recommendations of which games to play in this release.
