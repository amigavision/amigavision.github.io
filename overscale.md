...
* You can turn off the 5× Integer Overscale setting on MiSTer in the Options section of the launcher if you prefer to not have this be the default behavior. 
