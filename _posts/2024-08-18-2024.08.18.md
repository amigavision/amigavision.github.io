...
<video controls><source src="/videos/cd32-boot.mov" type="video/mp4">
...
* **Universe** — Underrated adventure game with fantastic graphics and an interesting storyline.
...
Also note that the Amiga core on Analogue Pocket does not have CD-ROM support (yet?), so this feature is only for MiSTer at the moment. Even if that core got support, you would need an external mouse or analog controller to operate the CD32 launcher, unfortunately.
