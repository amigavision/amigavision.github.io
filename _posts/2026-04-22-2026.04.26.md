...
Whenever you ship [the most significant update in your project's history](https://amiga.vision/2026.04.16), you have to plan for a fast-follow release to fix the issues that will inevitably surface — which we did, aiming to have ready 10 days later. Thank you to all the Amiga fans out there that identified a ton of hard-to-find issues in a setup with ~5000 game and demo configurations within the first few days! We couldn't do this without you.
