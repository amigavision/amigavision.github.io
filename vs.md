...
| Cold Boot → Playable Game — Raspberry Pi 5 | 22s | 2m 46s | 30s[^4] |
...
[^4]: Theoretical — PiMiga does not show a game selection screen but gets to Workbench where you can locate and start a game launcher. We added about 5 seconds for this.
