...
We are happy to announce that AmigaVision 2021.03.13 is released, and the biggest news in this release is *per-game* 5× scaling with Overscale.
...
* You can turn off the Overscale setting in the Options section of the launcher if you prefer to not have this be the default behavior. 
