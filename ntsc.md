...
In 2024&ndash;2026, we also reworked Amiga *emulator* scaling along with the author of [Amiberry](https://amiberry.com), which culminated in fixing this 30-year old Amiga scaling issue with the combined releases of [AmigaVision 2026.04.16](/2026.04.16) and Amiberry 8.1.
...
All of these align to your display's native pixel grid while having the correct Pixel Aspect Ratio, so you will not get any shimmering or non-integer scaled pixels.
