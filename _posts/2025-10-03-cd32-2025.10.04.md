...
published: true
redirect_from: "/2025-10-03-cd32-2025.10.03"
---
...
* Games that can make use of AmigaVision's [5×PAL Overscale](https://amiga.vision/overscale) presets — like Chaos Engine CD32 — now use that on a per-game basis when a game can handle it. 
...
In short, add this line to your `INI` file, and if you have other systems that you want to run in 50hz at other resolutions, add overrides for those. If none of this makes any sense to you, don't worry — this setting will not mess with the majority of the popular cores on the MiSTer.
...
[cares obsessively]:https://amiga.vision/ntsc
