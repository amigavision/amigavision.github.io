...
[^3]: Only Linux can switch automatically to 50 Hz. Windows and Mac emulators always run at 60 Hz, which causes tearing and stuttering when scrolling. It *is* possible to force your entire operating system to run at 50 Hz on some Windows computers, but the emulator can’t do it for you.
