...
## 🕹️ Time from Startup → Game Select {#boot}
...
[^3]: Theoretical — PiMiga *does not* show a game selection screen but gets to Workbench where you can locate and start a game launcher. We added about 5 seconds for this manual step.
...
[^15]: For 4K and 1080p displays, 5×PAL Overscale will let you run a lot of games using much more of your display. This is currently supported on MiSTer *&* Amiberry, and we are working on getting it supported in WinUAE and FS-UAE too. 
...
[^26]: In addition to top lists, AmigaVision includes curated lists made by creators, games organized by publisher, by musician, by theme, etc.
