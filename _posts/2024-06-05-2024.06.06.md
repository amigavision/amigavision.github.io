...
* Added optional `MiSTer.ini` settings for 1440p displays. Note that these will not use the [5×PAL Overscale](https://amiga.vision/overscale), those are only active for 1080p and 4K displays.
